...
int main(int argc, char** argv) {
    ...
    float percentT = (countT / 10000.0)*100.0;
    cout<<"Percentage of Valid Cards = "<<percentT;
    float percentF = (countF /10000.0)*100.0;
    cout<<"\nPercentage of Invalid Cards = "<<percentF;
